...
class ViewOverlayPreJellybean extends FrameLayout {
    ...
    private static final Field FIELD_VIEW_PARENT = ReflectionTool.getPrivateField(View.class, "mParent");
    ...
    public void addView(View child, int left, int top) {
        if (child.getParent() instanceof ViewGroup) {
            ...
            if (child.getParent() != null && FIELD_VIEW_PARENT != null) {
                ReflectionTool.setFieldValue(child, FIELD_VIEW_PARENT, null);
            }
