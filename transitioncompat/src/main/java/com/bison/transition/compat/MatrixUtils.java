...
public class MatrixUtils {
    ...
    private static final Field FIELD_DRAW_MATRIX = ReflectionTool.getPrivateField(ImageView.class, "mDrawMatrix");
    ...
    public static void animateTransform(ImageView imageView, Matrix matrix) {
        ...
        if (matrix == null || drawable.getIntrinsicWidth() == -1
            ...
            if (drawMatrix.isIdentity()) {
                ...
                ReflectionTool.setFieldValue(imageView, FIELD_DRAW_MATRIX, drawMatrix);
            }
