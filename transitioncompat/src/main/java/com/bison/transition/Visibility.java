...
import com.bison.transition.compat.ViewGroupCompat;
import com.bison.transition.compat.ViewGroupOverlayUtils;
...
public abstract class Visibility extends Transition {
    ...
    public Animator onAppear(ViewGroup sceneRoot,
        ...
        if (isForcedVisibility && !ViewCompat.isTransitionAlphaCompatMode()) {
            // Make sure that we reverse the effect of onDisappear's setTransitionAlpha(0)
            ViewCompat.setTransitionAlpha(endValues.view, 1);
        }
    ...
    public Animator onDisappear(final ViewGroup sceneRoot,
        ...
        if (viewToKeep != null) {
            ...
            if (!isForcedVisibility) {
                ...
                ViewCompat.setTransitionVisibility(viewToKeep, View.VISIBLE);
            }
            ...
            if (animator != null) {
                ...
                ViewCompat.setTransitionVisibility(viewToKeep, originalVisibility);
            }
            return animator;
        }
        return null;
    ...
    private static class DisappearListener extends AnimatorListenerAdapter
        ...
        public void onAnimationPause(Animator animation) {
            if (!mCanceled && !mIsForcedVisibility) {
                ViewCompat.setTransitionVisibility(mView, mFinalVisibility);
            }
        }
        ...
        public void onAnimationResume(Animator animation) {
            if (!mCanceled && !mIsForcedVisibility) {
                ViewCompat.setTransitionVisibility(mView, View.VISIBLE);
            }
        }
            ...
            if (!mCanceled) {
                if (mIsForcedVisibility) {
                    if (!ViewCompat.isTransitionAlphaCompatMode()) {
                        ViewCompat.setTransitionAlpha(mView, 0);
                    }
        ...
        private void suppressLayout(boolean suppress) {
            if (mLayoutSuppressed != suppress && mParent != null && !mIsForcedVisibility) {
                ...
                ViewGroupCompat.suppressLayout(mParent, suppress);
            }
        }
    }
}
