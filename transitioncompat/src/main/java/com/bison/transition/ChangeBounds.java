...
import com.bison.transition.compat.PointFProperty;
import com.bison.transition.compat.ViewCompat;
import com.bison.transition.compat.ViewGroupCompat;
import com.bison.transition.compat.ViewOverlayUtils;
...
public class ChangeBounds extends Transition {
    ...
    private void captureValues(TransitionValues values) {
        ...
        if (ViewCompat.isLaidOut(view, false) || view.getWidth() != 0 || view.getHeight() != 0) {
        ...
        if (parentMatches(startParent, endParent)) {
            ...
            if (numChanges > 0) {
                ...
                if (!mResizeClip || (startClip == null && endClip == null)) {
                    ViewCompat.setLeftTopRightBottom(view, startLeft, startTop, startRight, startBottom);
                    if (numChanges == 2) {
                    ...
                    ViewCompat.setLeftTopRightBottom(view, startLeft, startTop, startLeft + maxWidth,
                            startTop + maxHeight);
