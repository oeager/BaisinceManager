...
import com.bison.transition.compat.ArrayMap;
...
public class TransitionManager {
    ...
    public static void beginDelayedTransition(final ViewGroup sceneRoot, Transition transition) {
        if (!sPendingTransitions.contains(sceneRoot) && ViewCompat.isLaidOut(sceneRoot, true)) {
            if (Transition.DBG) {
    ...
    public static String getTransitionName(View v) {
        return ViewCompat.getTransitionName(v);
    }
}
