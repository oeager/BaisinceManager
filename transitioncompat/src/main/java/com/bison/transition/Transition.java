...
import com.bison.transition.compat.LongSparseArray;
import com.bison.transition.compat.Objects;
...
public abstract class Transition implements Cloneable {
    ...
    boolean isValidTarget(View target) {
        ...
        final String transitionName = ViewCompat.getTransitionName(target);
