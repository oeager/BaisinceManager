 ...
 * indication of a refresh. If an context wishes to show just the progress
...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        SwipeMode mode
                = SwipeMode.getFromInt(a2.getInt(R.styleable.SwipeRefreshLayout_mode, 0));
...
//                startScaleDownAnimation(mRefreshListener);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int realTop = childTop+mCurrentTargetOffsetTop+circleHeight;
        int realBottom = mCurrentTargetOffsetTop;
        switch (mDirection){
            case TOP:
                child.layout(childLeft,realTop , childLeft + childWidth, realTop + childHeight);
                break;
            case BOTTOM:
                child.layout(childLeft,realBottom-childHeight,childLeft+childWidth,realBottom);
                break;
        }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mBothDirection) {
                    ...
                    if ((mDirection == SwipeMode.BOTTOM && canChildScrollDown())
                            || (mDirection == SwipeMode.TOP && canChildScrollUp())) {
                        mInitialDownY = y;
                        return false;
                    }
                }
...
//        }
    ...
    public interface OnRefreshListener {
         void onRefresh(SwipeMode mode);
    }

    public SwipeMode getMode() {
        return mBothDirection ? SwipeMode.BOTH : mDirection;
    }
