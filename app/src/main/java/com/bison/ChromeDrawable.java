...
public class ChromeDrawable extends Drawable implements Drawable.Callback {
    ...
    public ChromeDrawable(int[] colors) {
    ...
    public static class Builder {
        ...
        private void initDefaults(Context context) {
            //Default values
            mColors = new int[]{0xFFC93437,0xFF375BF1,0xFFF7D23E,0xFF34A350};
            return;
        }
        ...
        public ChromeDrawable build() {
            return new ChromeDrawable(mColors);
        }
    }
}
